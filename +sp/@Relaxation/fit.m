function fit(obj, varargin)
    ...
    orbachx0 = [150, 1E-10]; ramanx0 = [5E-6, 8]; qtmx0 = [1E-4]; dipolex0 = [0.5, 1E4];
    orbachlb = [80, 1E-12]; ramanlb = [1E-9, 5]; qtmlb = [1E-6]; dipolelb = [0.1, 10];
    orbachub = [250, 1E-8]; ramanub = [1E-5, 9]; qtmub = [1E4]; dipoleub = [1, 1E5];
